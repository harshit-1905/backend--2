...
public class ApiResponse {
    ...
    @JsonProperty("enablePacMaintenanceBanner")
    public Boolean enablePacMaintenanceBanner;
    ...
    @JsonProperty("hidePacLoginForm")
    public Boolean hidePacLoginForm;
